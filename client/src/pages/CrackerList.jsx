...
//   // ✅ FILTER + SORT LOGIC
//   const filteredCrackers = crackers
//     .filter((c) =>
...
//   return (
//     <div className="p-5 bg-[#f1f5f9] min-h-screen">
//       <h2 className="text-3xl font-bold mb-6 text-center">
//         🎆 Available Crackers
//       </h2>

//       {/* 🔥 FILTER BAR */}
//       <div className="flex flex-col sm:flex-row gap-12 mb-15 justify-center sm:items-center">
...
//           className="w-full sm:w-1/3 px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-400 justify-center "
//         />
...
//         <p className="text-center">No crackers found</p>
//       ) : (
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
//           {filteredCrackers.map((c, i) => (
//             <motion.div
//               key={c._id}
...
//                 Stock: {c.stock > 0 ? c.stock : "Out of stock"}
//               </p>

//               <p className="bg-green-500 text-white text-xs rounded-sm py-1 px-2 w-fit mt-2">
//                 50% off
//               </p>
...
//       <div className="syne min-h-screen pb-24 relative overflow-x-hidden" style={{ background: "radial-gradient(ellipse at 20% 0%,#1a0800 0%,#0a0604 60%)" }}>
...
//           <p className="text-amber-900 font-semibold text-sm tracking-wide">
...
//         {/* STATS */}
//         {crackers.length > 0 && (
//           <motion.div className="flex items-center justify-center gap-8 px-6 pb-6 relative z-10"
...
//                   <div className="text-[10px] text-orange-900/70 tracking-[2px] uppercase mt-1">{s.label}</div>
//                 </div>
//               </div>
//             ))}
//           </motion.div>
...
//         {/* FILTER BAR */}
//         <motion.div
//           className="sticky top-0 z-50 flex flex-wrap gap-3 items-center justify-center px-5 py-3 border-b border-orange-950/40"
//           style={{ backdropFilter: "blur(20px)", background: "rgba(10,6,4,0.88)" }}
//           initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
//         >
//           {/* Search */}
//           <div className="relative flex-1 max-w-xs">
//             <span className="absolute left-3 top-1/2 -translate-y-1/2 text-orange-500 text-sm pointer-events-none">🔍</span>
//             <input
//               type="text"
//               placeholder="Search crackers..."
//               value={search}
//               onChange={(e) => setSearch(e.target.value)}
//               className="w-full pl-9 pr-4 py-2.5 rounded-xl text-sm font-semibold text-amber-100 placeholder-orange-950 transition-all duration-200"
//               style={{ background: "rgba(255,255,255,0.04)", border: "1.5px solid rgba(255,100,0,0.25)", outline: "none" }}
//               onFocus={(e) => (e.target.style.borderColor = "#ff6b00")}
//               onBlur={(e) => (e.target.style.borderColor = "rgba(255,100,0,0.25)")}
//             />
//           </div>

//           {/* Sort */}
//           <select value={sort} onChange={(e) => setSort(e.target.value)}
//             className="px-4 py-2.5 rounded-xl text-sm font-semibold text-amber-100 cursor-pointer outline-none"
//             style={{ background: "rgba(255,255,255,0.04)", border: "1.5px solid rgba(255,100,0,0.2)" }}>
//             <option value="" style={{ background: "#1a0800" }}>Sort By</option>
//             <option value="low" style={{ background: "#1a0800" }}>Price: Low → High</option>
//             <option value="high" style={{ background: "#1a0800" }}>Price: High → Low</option>
//           </select>

//           {/* Stock toggle */}
//           <label className="flex items-center gap-2 cursor-pointer text-[11px] font-bold tracking-widest text-orange-900 hover:text-yellow-400 transition-colors duration-200 uppercase select-none"
...
//                 className="text-[11px] font-bold tracking-widest text-orange-900 uppercase">
...
//                 <div className="bebas text-4xl tracking-widest" style={{ color: "#2a1008" }}>No Crackers Found</div>
//                 <p className="text-orange-950/50 mt-2 text-sm">Try adjusting your filters</p>
//               </motion.div>
//             ) : (
...
//                               </span>
//                               {!inStock && (
//                                 <span className="bg-zinc-700 text-white px-2 py-0.5 rounded text-[11px] font-black tracking-wide bebas">
//                                   SOLD OUT
//                                 </span>
//                               )}
//                               {inStock && c.stock < 5 && (
//                                 <span className="bg-amber-700 text-white px-2 py-0.5 rounded text-[11px] font-black tracking-wide bebas">
//                                   LOW STOCK
//                                 </span>
//                               )}
//                             </div>
...
//                               <span className="text-[10px] font-black text-yellow-400 tracking-wider px-2 py-0.5 rounded"
//                                 style={{ background: "rgba(255,215,0,0.08)" }}>
//                                 SAVE ₹{originalPrice - c.price}
//                               </span>
//                             </div>
